                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-6">
                            <div class="card-body p-4 p-sm-5">
                                ...
                                <form class="form-body" method="post" action="{{route('driver-login')}}">
                                    @csrf
                                    {{--                                    <div class="d-grid">--}}
                                    {{--                                        <a class="btn btn-white radius-30" href="javascript:;"><span class="d-flex justify-content-center align-items-center">--}}
                                    {{--                            <img class="me-2" src="{{asset('adminAsset')}}/assets/images/icons/search.svg" width="16" alt="">--}}
                                    ...
                                    <div class="row g-3">
                                        <div class="col-12">
                                            ...
                                            <div class="ms-auto position-relative">
                                                ...
                                                <input name='user_name'type="text" class="form-control radius-30 ps-5" id="inputEmailAddress" placeholder="Email Address/Phone">
                                            </div>
                                        </div>
                                        <div class="col-12">
...
<!--plugins-->
<script src="{{asset('adminAsset')}}/{{asset('adminAsset')}}/assets/js/jquery.min.js"></script>
